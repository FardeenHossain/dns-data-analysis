...
set output 'R2K1_top_lambda_jpdf.tex'

f1 = '../../../data/plots/R2K1_top_jpdf_lambda1.txt'
f2 = '../../../data/plots/R2K1_top_cond_mean_lambda1.txt'
f3 = '../../../data/plots/R2K1_top_jpdf_lambda2.txt'
f4 = '../../../data/plots/R2K1_top_cond_mean_lambda2.txt'
f5 = '../../../data/plots/R2K1_top_jpdf_lambda3.txt'
f6 = '../../../data/plots/R2K1_top_cond_mean_lambda3.txt'
...
set format x '%.1e'
set xtics(-3e5, -1.5e5, 0e5, 1.5e5, 3e5)
